# -*- coding: utf-8 -*-
"""
Created on Thu Feb 23 23:18:08 2017
...
with graph.as_default():
  ...
  #cross_entropy = tf.reduce_mean(
    ...
    #+0.0001*(tf.nn.l2_loss(layer1_weights) + tf.nn.l2_loss(layer1_biases) +\
  ...
  # Optimizer.
  optimizer = tf.train.RMSPropOptimizer(learning_rate=.001).minimize(cross_entropy) #94000 #98.3 #.001
  #optimizer = tf.train.GradientDescentOptimizer(learning_rate=.003).minimize(cross_entropy) #97
...
with tf.Session(graph=graph) as session:
  ...
  #print('Test accuracy (invalid): %.1f%%' % accuracy(test_prediction.eval(), test_labels))
...
submission.to_csv('new_pred_mnist.csv', index=False)